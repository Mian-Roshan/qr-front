...
<html lang="en">
    ...
    <body>
            <div class="main-wrapper">
                ...
                <div class="main ml-auto mr-auto position-relative">
                    ...
                    <div class="col-md-6 feature-right-text">
                        <div>
                            ...
                            <div class="grey-text text-md-right text-left">
                                ...
                                <p>Define the number of people the special offer shall apply to.</p>
                                <p>Enable/disable the offer without deleting it. You will only change its status.</p>
                            </div>
                        </div>
                    </div>
                </div>
